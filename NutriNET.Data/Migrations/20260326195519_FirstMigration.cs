    ...
    public partial class FirstMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentRestrictions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CommentRestrictions_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActionedOn = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FoodRequests_Users_ActionedById",
                        column: x => x.ActionedById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_FoodRequests_Users_SenderId",
                        column: x => x.SenderId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ModeratorRequests_Users_ActionedById",
                        column: x => x.ActionedById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_ModeratorRequests_Users_SenderId",
                        column: x => x.SenderId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RecipeLists_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    Name = table.Column<string>(type: "longtext", nullable: false),
                    PrivacyLevel = table.Column<byte>(type: "tinyint unsigned", nullable: false),
                    Image = table.Column<string>(type: "longtext", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MealFoods_Recipes_RecipeId",
                        column: x => x.RecipeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecipeListItems", x => new { x.RecipeListId, x.RecipeId });
                    table.ForeignKey(
                        name: "FK_RecipeListItems_RecipeLists_RecipeListId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommentRestrictions_UserId",
                table: "CommentRestrictions",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FoodRequests_ActionedById",
                table: "FoodRequests",
                column: "ActionedById");

            migrationBuilder.CreateIndex(
                name: "IX_FoodRequests_SenderId",
                table: "FoodRequests",
                column: "SenderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ModeratorRequests_ActionedById",
                table: "ModeratorRequests",
                column: "ActionedById");

            migrationBuilder.CreateIndex(
                name: "IX_ModeratorRequests_SenderId",
                table: "ModeratorRequests",
                column: "SenderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipeListItems_RecipeId",
